  ...
  <main className="landing-main" id="top">
   ...
   <section className="download-section" id="tai-app">
    ...
    <div className="download-grid">
     ...
     <a className="download-card android" href={androidDownload}><span className="download-icon"><Smartphone/></span><div><small>ĐIỆN THOẠI</small><h3>BOT 68 cho Android</h3><p>Android 9 trở lên</p><b><Download/> Tải APK v0.12.1</b></div></a>
    </div>
   </section>
  </main>
