...
const windowsDownload='https://github.com/thanh324-hash/sportxauth/releases/latest/download/BOT-68-Setup-0.11.0.exe'
  ...
  <main className="landing-main" id="top">
   ...
   <section className="download-section" id="tai-app">
    ...
    <div className="download-grid">
     <a className="download-card windows" href={windowsDownload}><span className="download-icon"><Monitor/></span><div><small>MÁY TÍNH</small><h3>BOT 68 cho Windows</h3><p>Windows 10/11 · 64-bit</p><b><Download/> Tải BOT 68 v0.11.0</b></div></a>
