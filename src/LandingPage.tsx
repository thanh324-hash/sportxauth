...
const windowsDownload='https://github.com/thanh324-hash/sportxauth/releases/download/v0.13.0/BOT-68-Setup-0.13.0.exe'
const androidDownload='https://github.com/thanh324-hash/sportxauth/releases/download/v0.13.0/BOT-68-Android-0.13.0.apk'
  ...
  <main className="landing-main" id="top">
   ...
   <section className="download-section" id="tai-app">
    ...
    <div className="download-grid">
     <a className="download-card windows" href={windowsDownload}><span className="download-icon"><Monitor/></span><div><small>MÁY TÍNH</small><h3>BOT 68 cho Windows</h3><p>Windows 10/11 · 64-bit</p><b><Download/> Tải BOT 68 v0.13.0</b></div></a>
     ...
     <a className="download-card android" href={androidDownload}><span className="download-icon"><Smartphone/></span><div><small>ĐIỆN THOẠI</small><h3>BOT 68 cho Android</h3><p>Android 9 trở lên</p><b><Download/> Tải APK v0.13.0</b></div></a>
    </div>
   </section>
  </main>
